...
afftool.setAffordanceConfig('Support', [6., 0.0001, 0.03]) # default (0.3,0.3,0.05) error, angle and area 
...
#r.startCapture("antCave_contactConesOnPeak","png") ; r.stopCapture()
...
for i in range(0,len(waypoints)):
    q = waypoints[i]; conesWP = rbprmBuilder.getContactCones (q); coneName = "ConesWP_"+str(i); coneGroupName = "ConesWP_contactCones"; plotContactCones (conesWP, ps, r, coneName, "friction_cone2"); r.client.gui.addToGroup (coneName, coneGroupName)

#gui.writeNodeFile('ConesWP_contactCones','ConesWP_contactCones.dae')
"""
