...
obstacleName = "parkour_smallWallsExample"
...
q11[0:7] = [-3.7, 0, 3.86, 1, 0, 0, 0]; r(q11)

rbprmBuilder.isConfigValid(q11)

q22 = q11[::]
#q22[0:7] = [4, -1, 0.9, 1, 0, 0, 0]; r(q22)
q22[0:7] = [2.9, 0, 0.57, 1, 0, 0, 0]; r(q22)
...
waypoint = q11[::]
waypoint[0:7] = [-0.2, 0, 2.65, 1, 0, 0, 0]; r(waypoint) # stand up
waypoint[0:7] = [-0.2, 0, 2.65, 1, 0, 0, 0]; r(waypoint) # on hands
rbprmBuilder.isConfigValid(waypoint)
...
ps.setInitialConfig (q11); ps.addGoalConfig (waypoint); ps.solve (); ps.resetGoalConfigs (); pp.displayPath(ps.numberPaths () - 1, [0.5, 0.0, 0.8, 1.0]) # V0 6.04  Vimp 8.35
ps.setInitialConfig (waypoint); ps.addGoalConfig (q22); ps.solve (); ps.resetGoalConfigs (); pp.displayPath(ps.numberPaths () - 1, [0.5, 0.0, 0.8, 1.0])
